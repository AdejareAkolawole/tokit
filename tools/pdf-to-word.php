...
if (isset($_POST['convert_pdf'])) {
    if (isset($_FILES['pdf_file']) && $_FILES['pdf_file']['error'] == 0) {
        ...
        try {
            ...
            // 4. Handle multiline text properly
            $lines = explode("\n", $text);
        ...
        <div class="bg-white border border-gray-100 p-10 rounded-[2.5rem] shadow-xl shadow-gray-200/50">
            <form method="POST" enctype="multipart/form-data" class="space-y-8">
                <div class="border-2 border-dashed border-gray-200 rounded-3xl p-12 text-center hover:border-blue-400 transition-all bg-gray-50/50">
                    ...
                    <input type="file" name="pdf_file" id="pdf_file" accept=".pdf" class="hidden" onchange="updateFileName()">
                    ...
                    <div id="file-name-display" class="mt-4 text-blue-600 font-medium"></div>
                </div>
            ...
            <?php if ($success_file): ?>
                <div class="mt-8 p-6 bg-blue-50 border border-blue-100 rounded-[2rem] animate-in fade-in zoom-in">
                    <div class="flex items-center justify-between gap-4">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <h4 class="font-bold text-blue-900">Conversion Ready!</h4>
                                <p class="text-blue-700 text-sm">Your Word document is ready.</p>
                            </div>
                        </div>
